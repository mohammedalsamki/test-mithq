...
//offeset var 
    ...
    let oppes=arr[0][202001][11][0].claims_amount
    let oppes2=arr[0][202002][10][0].claims_amount
    let oppes3=arr[0][202003][9][0].claims_amount
    let oppes4=arr[0][202004][8][0].claims_amount
    let oppes5=arr[0][202005][7][0].claims_amount
    let oppes6=arr[0][202006][6][0].claims_amount
    let oppes7=arr[0][202007][5][0].claims_amount
    let oppes8=arr[0][202008][4][0].claims_amount
    let oppes9=arr[0][202009][3][0].claims_amount
    let oppes10=arr[0][202010][2][0].claims_amount
    let oppes11=arr[0][202011][1][0].claims_amount
    let oppes12=arr[0][202012][0][0].claims_amount
    ...
    for (let index = 0; index < 11; index++) {
        element1 = arr[0][year1][0][0].claims_amount
        count1 += element1
        element2 = arr[0][year1][1][0].claims_amount
        count2 += element2
        year1 += 1
    ...
    for (let index = 0; index < 10; index++) {
        element31 = arr[0][year3][2][0].claims_amount
        count31 += element31
        element21 = arr[0][year3][1][0].claims_amount
        count21 += element21
        year3 += 1
    ...
    for (let index = 0; index < 9; index++) {
        element3 = arr[0][year2][2][0].claims_amount
        count3 += element3
        element4 = arr[0][year2][3][0].claims_amount
        count4 += element4
        year2 += 1
    ...
    for (let index = 0; index < 8; index++) {
        element5 = arr[0][year4][4][0].claims_amount
        count5 += element5
        element41 = arr[0][year4][3][0].claims_amount
        count41 += element41
        year4 += 1
    ...
    for (let index = 0; index < 7; index++) {
        element6 = arr[0][year5][5][0].claims_amount
        count6 += element6
        element51 = arr[0][year5][4][0].claims_amount
        count51 += element51
        year5 += 1
    ...
    for (let index = 0; index < 6; index++) {
        element7 = arr[0][year6][6][0].claims_amount
        count7 += element7
        element61 = arr[0][year6][5][0].claims_amount
        count61 += element61
        year6 += 1
    ...
    for (let index = 0; index < 5; index++) {
        element8 = arr[0][year7][7][0].claims_amount
        count8 += element8
        element71 = arr[0][year7][6][0].claims_amount
        count71 += element71
        year7 += 1
    ...
    for (let index = 0; index < 4; index++) {
        element9 = arr[0][year8][8][0].claims_amount
        count9 += element9
        element81 = arr[0][year8][7][0].claims_amount
        count81 += element81
        year8 += 1
    ...
    for (let index = 0; index < 3; index++) {
        element10 = arr[0][year9][9][0].claims_amount
        count10 += element10
        element91 = arr[0][year9][8][0].claims_amount
        count91 += element91
        year9 += 1
    ...
    for (let index = 0; index < 2; index++) {
        element11 = arr[0][year10][10][0].claims_amount
        count11 += element11
        element101 = arr[0][year10][9][0].claims_amount
        count101 += element101
        year10 += 1
    ...
    for (let index = 0; index < 1; index++) {
        element12 = arr[0][year11][11][0].claims_amount
        count12 += element12
        element111 = arr[0][year11][10][0].claims_amount
        count111 += element111
        year11 += 1
	...
	return(
		<div>
         ...
         <tr>
            <td>202001</td>
        {JsonData[0][202001].map(item=>(<td> {item[0].claims_amount}   </td> ))}
       </tr>
       <tr>
            <td>202002</td>
        {JsonData[0][202002].map(item=>(<td>  {item[0].claims_amount}   </td> ))}
       </tr>
       <tr>
            <td>202003</td>
        {JsonData[0][202003].map(item=>(<td>  {item[0].claims_amount}   </td> ))}
       </tr>
       <tr>
            <td>202004</td>
        {JsonData[0][202004].map(item=>(<td>  {item[0].claims_amount}   </td> ))}
       </tr>
       <tr>
            <td>202005</td>
        {JsonData[0][202005].map(item=>(<td>  {item[0].claims_amount}   </td> ))}
       </tr>
       <tr>
            <td>202006</td>
        {JsonData[0][202006].map(item=>(<td>  {item[0].claims_amount}   </td> ))}
       </tr>
       <tr>
            <td>202007</td>
        {JsonData[0][202007].map(item=>(<td>  {item[0].claims_amount}   </td> ))}
       </tr>
       <tr>
            <td>202008</td>
        {JsonData[0][202008].map(item=>(<td>  {item[0].claims_amount}   </td> ))}
       </tr>
       <tr>
            <td>202009</td>
        {JsonData[0][202009].map(item=>(<td>  {item[0].claims_amount}   </td> ))}
       </tr>
       <tr>
            <td>202010</td>
        {JsonData[0][202010].map(item=>(<td>  {item[0].claims_amount}   </td> ))}
       </tr>
       <tr>
            <td>202011</td>
        {JsonData[0][202011].map(item=>(<td>  {item[0].claims_amount}   </td> ))}
       </tr>
       <tr>
            <td>202012</td>
        {JsonData[0][202012].map(item=>(<td>  {item[0].claims_amount}   </td> ))}
       </tr>
        ...
        <table class="tableneww">
            ...
            <thead>
                ...
                <tr>
                        ...
                        <td>{Math.round(oppes7*Number(sumofsum6*sumofsum7
